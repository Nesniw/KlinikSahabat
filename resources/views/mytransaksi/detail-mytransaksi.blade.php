        ...
        <div class="row pt-5 gx-5">
            ...
            <div class="col-xl-9"> 
                <nav class="nav nav-borders">
                    <a class="nav-link active ms-0" href="{{route('DetailMyTransaksi', $transaksi->transaksi_id)}}">Informasi Transaksi</a>
                ...
                <div class="row gx-3 my-3">
                    <div class="col-md-7">
                        <div class="card mb-4 shadow">
                            <div class="card-body">
                                <h5 class="m-2">Informasi Layanan</h5>
                                <hr>
                                <table class="table table-borderless mb-4">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Jumlah Hari</td>
                                            <td>:</td>
                                            <td>{{ $transaksi->lama_tinggal }} hari</td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="col-md-5">
                        <div class="card mb-4">
                            <div class="card-body">
                            <h5 class="m-2">Informasi Hewan</h5>
                                <hr>
                                <table class="table table-borderless mb-4">
                                    <tbody>
                                        <tr>
                                            <td>Nama Hewan</td>
                                            <td>:</td>
                                            <td >{{ $transaksi->pets->namapasien }}</td>
                                        </tr>
                                        <tr>
                                            <td>Jenis</td>
                                            <td>:</td>
                                            <td>{{ $transaksi->pets->jenishewan }}</td>
                                        </tr>
                                        <tr>
                                            <td>Ras</td>
                                            <td>:</td>
                                            <td>{{ $transaksi->pets->ras }}</td>
                                        </tr>
                                        <tr>
                                            <td>Jenis Kelamin</td>
                                            <td>:</td>
                                            <td>{{ $transaksi->pets->jeniskelamin }}</td>
                                        </tr>
                                        <tr>
                                            <td>Berat</td>
                                            <td>:</td>
                                            <td>{{ $transaksi->pets->berat }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
