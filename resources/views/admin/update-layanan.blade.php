                                        ...
                                        <form method="POST" action="{{ route ('UpdateLayananData', ['layanan_id' => $layanan->layanan_id]) }}">
                                            ...
                                            <div class="row gx-5 mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="kategori_layanan_id" class="form-control form-select" id="kategori_layanan_id" required>
                                                        <option value="{{ $layanan->kategori_layanan_id }}" selected>{{ $NamaKategori }}</option>
                                                        <!-- Menampilkan opsi kategori_layanan_id lainnya -->
                                                        @foreach($kategori as $kgor)
                                                            @if($kgor->kategori_layanan_id != $layanan->kategori_layanan_id)
                                            ...
                                            <div class="row gx-5 mb-4">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="deskripsi_layanan" name="deskripsi_layanan" required>{{ old('deskripsi_layanan', $layanan->deskripsi_layanan) }}</textarea>
                                                </div>
                                            </div>
                                            <!-- Save changes button-->
