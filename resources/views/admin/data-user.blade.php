            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Data User</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-3">
                            ...
                            <div class="p-6 bg-white border-b border-gray-200">
                                <div class="overflow-x-auto bg-white" data-theme="lofi">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="text-gray-900">{{ $item ->fullname}}</td>
                                        <td class="text-gray-900">{{ $item ->jeniskelamin}}</td>
                                        <td class="text-gray-900">{{ \Carbon\Carbon::parse($item->tanggallahir)->format('d-m-Y') }}</td>
                                        <td class="text-gray-900">{{ $item ->alamat}}</td>
                                        <td class="text-gray-900">{{ $item ->roles}}</td>
                                        <td class="text-gray-900">{{ $item ->email}}</td>
                                        <td class="text-gray-900">{{ $item ->nomortelepon}}</td>
                                        <td>
                                            <a href="/userdata/{{$item->id}}/edit" type="button" class="btn btn-primary">Update</a>
