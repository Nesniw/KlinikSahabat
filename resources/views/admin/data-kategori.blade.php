            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class=" mb-0 text-gray-800">Data Kategori Layanan - Klinik Sahabat Hewan</h2>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="fas fa-download fa-sm text-white-50"></i> Generate Report
                        </a>
                    </div>

                    <a href="{{ route('CreateKategoriForm') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-3">
                        <i class="fa fa-plus fa-sm color-white"></i> Tambah Kategori
                    </a>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: false,
                serverSide: true,
                ajax: "{{ route('ShowKategoriData') }}",
                columns: [
                    { data: 'kategori_layanan_id', name: 'kategori_layanan_id'},
