                ...
                <div class="row gy-4 gy-xl-4 p-4 p-xl-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group pt-2">
                            <a class="logregLinkPass" href="{{ route('password.request') }}">Lupa Password?</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="d-grid">
                            ...
                            <hr>
                            <a class="logregLink" href="{{ route('register') }}">Belum Memiliki Akun? Register</a>
                        </div>
                    </div>
                </div>
            </form>
