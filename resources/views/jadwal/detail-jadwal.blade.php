                                    ...
                                    <form method="GET" action="{{route('ShowJadwalKlinik')}}">
                                        ...
                                        <div class="row gx-5 mb-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="kategori_layanan_id" class="form-control form-select" id="kategori_layanan_id" readonly>
                                                    <option value="{{ $jadwalKlinik->layanan->kategoriLayanan->nama_kategori }}" readonly>{{ $jadwalKlinik->layanan->kategoriLayanan->nama_kategori }}</option>
                                                </select>
                                            </div>
